              ...
              <div className="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      <p className="mb-2 font-bold text-primary">Төв салбар</p>
                      <p className="text-neutral-500 text-primary">
                        Улаанбаатар хот, Сүхбаатар дүүрэг, 11-р хороо, 7-р
                        хороолол, Ногоон нуурын гудамж 25, Прован/PRO-ONE/ оффис
                        309 тоот
                      </p>
                      <p className="text-neutral-500 text-primary">
                        9097-8085, 9105-808
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      <p className="mb-2 font-bold text-primary">БЗД салбар</p>
                      <p className="text-neutral-500 text-primary">
                        Улаанбаатар хот, Баянзүрх дүүрэг, 16-р хороо,
                        Дандарбаатарын гудамж, Соёмбо төв 304 тоот
                      </p>
                      <p className="text-neutral-500 text-primary">
                        9097-8085, 9105-808
                      </p>
