...
const Provide = () => {
  return (
    <div id="services">
      <div className="mx-auto max-w-7xl px-4 my-7 sm:py-20 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* COLUMN-1 */}
          <div className="col-span-6 flex justify-center">
            <div className="flex flex-col align-middle justify-center p-10">
              <p className="text-4xl lg:text-6xl pt-4 font-semibold lh-81 mt-5 text-center lg:text-start">
                Дэлхийн жишигт нийцсэн
              </p>
              <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">
                Манай банк бус санхүүгийн байгууллага нь 2016 оны 5 дугаар сарын
                17-ны өдрийн Санхүүгийн Зохицуулах Хорооны 162 тоот тогтоолоор
                Санхүүгийн зээлийн үйл ажиллагаа эрхлэх тусгай зөвшөөрлөө авч
                банк санхүүгийн салбарт тогтвортой үйл ажиллагаагаа явуулж
                байна.
              </h4>
              <Link
                href={"/about"}
